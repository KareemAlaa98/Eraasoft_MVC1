namespace Hospital_Appointment.Models
{
    public class SampleDataDoctor
    {
        ...
        public SampleDataDoctor()
        {
            ...
            new Doctor { Id = 2, Name = "Dr. Harry Johnson", Specialization = "Pediatrics", Img = "doctor2.jpg" },
            ...
            new Doctor { Id = 5, Name = "Dr. Marry Clark", Specialization = "Neurology", Img = "doctor5.jpg" },
            };
        }
